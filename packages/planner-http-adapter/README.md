...
import {
  ...
  buildBrowserContext,
  syncSessionWithRun,
} from "@webgpt-mundhada/planner-http-adapter";
```
...
the selected backend actually exposes the optional planner-context route. See
the repository [Security Policy](https://github.com/saket77/webgpt-frontend/blob/develop/SECURITY.md)
and [Planner Adapter Contract](https://github.com/saket77/webgpt-frontend/blob/develop/docs/planner-adapter-contract.md).
...
```sh
npm test --workspace @webgpt-mundhada/planner-http-adapter
```
